...
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| Schema Type | MySQL           | Oracle          | PostgreSQL       | Snowflake        | SQLite  | SQL Server     |
+=============+=================+=================+==================+==================+=========+================+
| INT8        | TINYINT         | NUMBER(3,0)     | SMALLINT         | NUMBER           | NUMERIC | TINYINT        |
+-------------+-----------------+-----------------+------------------+------------------+--------------------------+
| INT16       | SMALLINT        | NUMBER(5,0)     | SMALLINT         | NUMBER           | NUMERIC | SMALLINT       |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| INT32       | INT             | NUMBER(10,0)    | INT              | NUMBER           | NUMERIC | INT            |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| INT64       | BIGINT          | NUMBER(19,0)    | BIGINT           | NUMBER           | NUMERIC | BIGINT         |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| FLOAT32     | FLOAT           | BINARY_FLOAT    | REAL             | FLOAT            | REAL    | REAL           |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| FLOAT64     | DOUBLE          | BINARY_DOUBLE   | DOUBLE PRECISION | FLOAT            | REAL    | FLOAT          |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| BOOLEAN     | TINYINT         | NUMBER(1,0)     | BOOLEAN          | BOOLEAN          | NUMERIC | BIT            |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| STRING      | VARCHAR(256)    | NCLOB           | TEXT             | VARCHAR          | TEXT    | VARCHAR(MAX)   |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| BYTES       | VARBINARY(1024) | BLOB            | BYTEA            | VARBINARY        | BLOB    | VARBINARY(MAX) |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| 'Decimal'   | DECIMAL(65,s)   | NUMBER(*,s)     | DECIMAL          | NUMBER(38,s)     | NUMERIC | DECIMAL(38,s)  |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| 'Date'      | DATE            | DATE            | DATE             | DATE             | NUMERIC | DATE           |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| 'Time'      | TIME(3)         | DATE            | TIME             | TIME             | NUMERIC | TIME           |
+-------------+-----------------+-----------------+------------------+------------------+---------+----------------+
| 'Timestamp' | TIMESTAMP(3)    | TIMESTAMP       | TIMESTAMP        | TIMESTAMP_LTZ    | NUMERIC | DATETIME2      |
+-------------+-----------------+-----------------+------------------+------------------+--------------------------+
